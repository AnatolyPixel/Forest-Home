...
var _initPhoneInput = require("./modules/form-validate/init-phone-input");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var button2 = document.getElementById('order');
  scrollButton.addEventListener('click', function () {
    button2.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var scrollButton2 = document.getElementById('scroll2');
  var button22 = document.getElementById('order');
  scrollButton2.addEventListener('click', function () {
    button22.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var scrollButton3 = document.getElementById('scroll3');
  var button33 = document.getElementById('order');
  scrollButton3.addEventListener('click', function () {
    button33.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var scrollButton4 = document.getElementById('scroll4');
  var button44 = document.getElementById('order');
  scrollButton4.addEventListener('click', function () {
    button44.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var scrollButton5 = document.getElementById('scroll5');
  var button55 = document.getElementById('order');
  scrollButton5.addEventListener('click', function () {
    button55.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var scrollButton6 = document.getElementById('scroll6');
  var button66 = document.getElementById('order');
  scrollButton6.addEventListener('click', function () {
    button66.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var scrollButton11 = document.getElementById('scroll11');
  var button11 = document.getElementById('order');
  scrollButton11.addEventListener('click', function () {
    button11.scrollIntoView({
      behavior: 'smooth'
    });
  });
  var searchInput = document.getElementById('searchInput');
  var headings = document.querySelectorAll('h2,h1,h3');
  searchInput.addEventListener('input', function () {
    ...
    headings.forEach(function (heading) {
      ...
      if (headingText.includes(searchText)) {
        ...
        heading.setAttribute('id', "heading-".concat(headingText));
      } else {
  ...
  window.addEventListener('DOMContentLoaded', function () {
    var allAnchorLinks = document.querySelectorAll('a[href^="#heading-"]');
  ...
  var parent = document.querySelector('.input-group');
  (0, _initPhoneInput.initPhoneInput)(parent);
  ...
  window.addEventListener('load', function () {
    ...
    var modalButton = document.querySelector('.btn-order');
    var modal = document.querySelector('.modal');
    var inputName = document.getElementById('Name');
    var modalOverlay = document.querySelector('.modal__overlay');

    // Получаем ссылку на элемент для закрытия модального окна
    var closeButton = modal.querySelector('.modal__close-btn');
    ...
    var parent = modal.querySelector('.input-group');
    (0, _initPhoneInput.initPhoneInput)(parent);
  ...
  var modalAboutOverlay = document.querySelector('.modal-about__overlay');

  // Получаем ссылку на элемент для закрытия модального окна
  var closeAboutButton = modalAbout.querySelector('.modal-about__close-btn');
...
},{"./modules/form-validate/form":3,"./modules/form-validate/init-phone-input":4,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
